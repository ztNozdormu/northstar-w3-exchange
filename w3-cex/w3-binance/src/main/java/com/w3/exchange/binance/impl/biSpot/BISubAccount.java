...
import com.w3.exchange.common.domain.SubAccount;
 ...
 */
public class BISubAccount extends SubAccount {

    public BISubAccount(String baseUrl, String apiKey, String secretKey, boolean showLimitUsage) {
