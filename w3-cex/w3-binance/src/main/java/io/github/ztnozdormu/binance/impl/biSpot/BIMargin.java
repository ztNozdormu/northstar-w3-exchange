...
import io.github.ztnozdormu.common.domain.Margin;
 ...
 */
public class BIMargin extends Margin {


    public BIMargin(String baseUrl, String apiKey, String secretKey, boolean showLimitUsage) {
