...
import io.github.ztnozdormu.common.domain.GiftCard;
 ...
 */
public class BIGiftCard extends GiftCard {

    public BIGiftCard(String baseUrl, String apiKey, String secretKey, boolean showLimitUsage) {
