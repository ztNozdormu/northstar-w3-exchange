...
import io.github.ztnozdormu.common.domain.Wallet;
 ...
 */
public class BIWallet extends Wallet {

    public BIWallet(String baseUrl, String apiKey, String secretKey, boolean showLimitUsage) {
