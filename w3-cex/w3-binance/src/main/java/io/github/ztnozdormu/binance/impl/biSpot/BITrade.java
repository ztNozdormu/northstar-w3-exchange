...
import io.github.ztnozdormu.common.domain.Trade;
 ...
 */
public class BITrade extends Trade {

    public BITrade(String baseUrl, String apiKey, String secretKey, boolean showLimitUsage) {
