...
import io.github.ztnozdormu.common.domain.Savings;
 ...
 */
public class BISavings extends Savings {

    public BISavings(String baseUrl, String apiKey, String secretKey, boolean showLimitUsage) {
