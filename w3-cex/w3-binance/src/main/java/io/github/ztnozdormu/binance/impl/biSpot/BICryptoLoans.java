...
import io.github.ztnozdormu.common.domain.CryptoLoans;
 ...
 */
public class BICryptoLoans extends CryptoLoans {

    public BICryptoLoans(String baseUrl, String apiKey, String secretKey, boolean showLimitUsage) {
