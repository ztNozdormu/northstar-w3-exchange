...
import io.github.ztnozdormu.common.domain.Blvt;
 ...
 */
public class BIBlvt extends Blvt {

    public BIBlvt(String baseUrl, String apiKey, String secretKey, boolean showLimitUsage) {
