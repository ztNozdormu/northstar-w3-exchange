...
import io.github.ztnozdormu.common.domain.Market;
...
import io.github.ztnozdormu.common.utils.JSONParser;
 ...
 */
public class BIMarket extends Market {

    public BIMarket(String baseUrl, String apiKey, boolean showLimitUsage) {
