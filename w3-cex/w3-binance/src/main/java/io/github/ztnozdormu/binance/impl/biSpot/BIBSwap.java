...
import io.github.ztnozdormu.common.domain.BSwap;
 ...
 */
public class BIBSwap extends BSwap {

    public BIBSwap(String baseUrl, String apiKey, String secretKey, boolean showLimitUsage) {
