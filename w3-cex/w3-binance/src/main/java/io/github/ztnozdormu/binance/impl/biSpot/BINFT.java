...
import io.github.ztnozdormu.common.domain.NFT;
 ...
 */
public class BINFT extends NFT {

    public BINFT(String baseUrl, String apiKey, String secretKey, boolean showLimitUsage) {
