...
import io.github.ztnozdormu.common.domain.UserData;
 ...
 */
public class BIUserData extends UserData {


    public BIUserData(String baseUrl, String apiKey, boolean showLimitUsage) {
