...
import io.github.ztnozdormu.common.domain.Futures;
 ...
 */
public class BIFutures extends Futures {

    public BIFutures(String baseUrl, String apiKey, String secretKey, boolean showLimitUsage) {
