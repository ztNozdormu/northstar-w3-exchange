...
import io.github.ztnozdormu.common.domain.Staking;
 ...
 */
public class BIStaking extends Staking {

    public BIStaking(String baseUrl, String apiKey, String secretKey, boolean showLimitUsage) {
