...
import io.github.ztnozdormu.common.domain.Mining;
 ...
 */
public class BIMining extends Mining {

    public BIMining(String baseUrl, String apiKey, String secretKey, boolean showLimitUsage) {
